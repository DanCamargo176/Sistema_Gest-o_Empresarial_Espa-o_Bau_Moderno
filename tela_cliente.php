...
<label class="titulo_cliente"><h1><center>Consulta/Cadastro de Clientes</center></h1></label>
    <div class="dropdown">
  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">O que deseja fazer?
  <span class="caret"></span></button>
  <ul class="dropdown-menu">
    <li><a href="cad_cli.php">Novo Cliente</a></li>
    <li><a href="lista_cli.php">Consultar Clientes</a></li>
