...
<head>
    ...
    load_dados(null, 'pesquisa_func.php', '#MostraPesq');
    ...
    $('#pesquisaAdmin').keyup(function(){
        ...
        {
            load_dados(valores, 'pesquisa_func.php', '#MostraPesq');
        }else
        {
            load_dados(null, 'pesquisa_func.php', '#MostraPesq');
        }
				...
				<fieldset>
					<legend>Digite o nome a pesquisar</legend>
						<div class="input-prepend">
							...
							<input type="text" name="pesquisaFunc" id="pesquisaFunc" value="" tabindex="1" placeholder="Pesquisar Funcionário..." />
						</div>
				</fieldset>
			</form>
