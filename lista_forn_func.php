...
<head>
    ...
    $('#pesquisaForn').keyup(function(){
        ...
        {
            load_dados(valores, 'pesquisa_forn_func.php', '#MostraPesq');
        }else
        {
            load_dados(null, 'pesquisa_forn_func.php', '#MostraPesq');
        }
	...
	<center>
		<article>
			<form name="form_pesquisa" id="form_pesquisa" method="post" action="">
				<fieldset>
					<legend>Digite o fornecedor a pesquisar</legend>
						<div class="input-prepend">
							<span class="add-on"><i class="icon-search"></i></span>
							<input type="text" name="pesquisaFunc" id="pesquisaFunc" value="" tabindex="1" placeholder="Pesquisar Fornecedor..." />
						</div>
				</fieldset>
			</form>
            <a href="tela_fornecedor_func.php">Sair</a>
