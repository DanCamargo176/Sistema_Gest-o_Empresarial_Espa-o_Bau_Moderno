...
<label class="titulo_cliente"><h1><center>Consulta/Cadastro de Usuários</center></h1></label>
    <div class="dropdown">
  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">O que deseja fazer?
  <span class="caret"></span></button>
  <ul class="dropdown-menu">
    <li><a href="cad_user.php">Novo Usuário</a></li>
    <li><a href="lista_admin.php">Consultar Administradores</a></li>
    <li><a href="lista_func.php">Consultar Funcionários</a></li>
    <li><a href="index_adm.php">Voltar</a></li>
  </ul>
</div>
</div>
